...
const FLAG_MAP: Record<string, string> = {
  ...
  'メキシコ':'🇲🇽','ペルー':'🇵🇪','ボリビア':'🇧🇴','エクアドル':'🇪🇨',
  'ジャマイカ':'🇯🇲','キューバ':'🇨🇺','ドミニカ共和国':'🇩🇴','ハイチ':'🇭🇹','プエルトリコ':'🇵🇷',
'ベネズエラ':'🇻🇪',

  // アフリカ
  'エチオピア':'🇪🇹','ケニア':'🇰🇪','ルワンダ':'🇷🇼','ブルンジ':'🇧🇮',
  'ウガンダ':'🇺🇬','タンザニア':'🇹🇿','コンゴ民主共和国':'🇨🇩',
  'コートジボワール':'🇨🇮','コートジヴォワール':'🇨🇮','南アフリカ':'🇿🇦','カメルーン':'🇨🇲','マラウイ':'🇲🇼','ジンバブエ':'🇿🇼','エスワティニ':'🇸🇿',   // 旧スワジランド

  // アジア
  'イエメン':'🇾🇪','インドネシア':'🇮🇩','東ティモール':'🇹🇱','ベトナム':'🇻🇳',
  'インド':'🇮🇳','タイ':'🇹🇭','ラオス':'🇱🇦','ミャンマー':'🇲🇲',
  'フィリピン':'🇵🇭','中国':'🇨🇳','日本':'🇯🇵','ネパール':'🇳🇵',
  'パプアニューギニア':'🇵🇬','ソロモン諸島':'🇸🇧','カンボジア':'🇰🇭',
};
...
const ALIASES: Record<string, string> = {
  ...
  // --- ALIASES に表記ゆれを吸収するエイリアスを追加 ---

// ベネズエラ
'ヴェネズエラ':'ベネズエラ','Venezuela':'ベネズエラ',

// プエルトリコ
'プエルト・リコ':'プエルトリコ','Puerto Rico':'プエルトリコ',

// エスワティニ（旧称）
'スワジランド':'エスワティニ','スワジーランド':'エスワティニ','Eswatini':'エスワティニ','Swaziland':'エスワティニ',

// カメルーン
'Cameroon':'カメルーン',

// マラウイ
'マラウィ':'マラウイ','Malawi':'マラウイ',
