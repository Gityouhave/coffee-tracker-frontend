...
// クライアント側にも簡潔なセオリー辞書を持たせて、未保存の段階でも表示
const ORIGIN_THEORY: Record<string,string> = {
  'ケニア':'明るい酸、ベリー/柑橘の果実味、持続する甘み。',
  'エチオピア':'ジャスミンや柑橘、紅茶のような余韻。',
  'ブラジル':'ナッツ、ミルクチョコ、低酸で飲みやすい。',
  'コロンビア':'キャラメルと柑橘の調和、丸い口当たり。',
  'グアテマラ':'バランス良くナッツとチョコ、穏やかな酸。',
  'ルワンダ':'蜂蜜や紅茶感、甘いストーンフルーツ。'
  // 必要に応じて追加（サーバ辞書と概ね一致）
}
const PROCESS_THEORY: Record<string,string> = {
  'ナチュラル':'華やかな風味と甘み、熟した果実味。',
  'ウォッシュド':'クリーンで明瞭、酸が際立ちやすい。',
  'ハニー':'甘みとコクの中庸（残す粘質量で変化）。',
  'レッドハニー':'濃い甘みと果実味、厚みのある口当たり。',
  'イエローハニー':'明るい甘み、バランス。',
  'ホワイトハニー':'よりクリーンで軽やか。',
  'スマトラ':'アーシーでスパイシー、厚いボディ。'
}
const ADDL_THEORY: Record<string,string> = {
  'アナエロビック':'無酸素発酵由来のスパイシーで個性的。',
  'モンスーン':'穀物感、低酸、独特の熟成感。',
  'インフューズド':'外的フレーバーで個性付け。',
  'バレルエイジド':'樽由来の香りと甘い余韻。',
  'エイジング':'角が取れて丸みが出やすい。'
}
