...
const DRIPPER_DETAILS: Record<string, DripperDetail> = {
  'ハリオ': {
    ...
    tags: [
      '焙煎: 浅〜中浅◎', '精製: ウォッシュト/ハニー向き', '産地: 東アフリカ/中米', '風味: 高香り/クリーン',
      '抽出: 透過式', '流速: 注湯依存（中〜速）',
      '輪郭が出る', '軽快', '再現性=中（手技影響大）'
    ]
  },
  'フラワー': {
    short: '華やかな香りを引き出す',
    ...
    tags: [
      '焙煎: 浅〜中浅◎', '精製: ナチュラル/ウォッシュト', '産地: 東アフリカ', '風味: 高香り/華やか',
      '抽出: 透過式', '流速: やや速',
      '高香り系', '軽やか', 'リブ深めで通気'
    ]
  },
  'カリタウェーブ': {
    ...
    tags: [
      '焙煎: 全域対応（中庸）', '精製: 全般', '産地: 汎用', '風味: バランス/まとまり',
      '抽出: 透過式（平底/3穴）', '流速: 中',
      '再現性高', '丸み', '安定志向'
    ]
  },
  'コーノ': {
    ...
    tags: [
      '焙煎: 中〜中深◎', '精製: ウォッシュト/ハニー', '産地: 中米/南米', '風味: 甘み/質感',
      '抽出: 透過×浸漬', '流速: 中〜やや遅',
      'とろみ', '甘みが乗る'
    ]
  },
  'クレバー': {
    ...
    tags: [
      '焙煎: 中〜深◎', '精製: ナチュラル/発酵系◎', '産地: ブラジル/スマトラ系', '風味: 甘み/ボディ',
      '抽出: 浸漬式（バルブ開放）', '流速: 遅（浸漬）',
      '再現性高', '丸め/角を取る'
    ]
  },
  'ハリオスイッチ': {
    ...
    tags: [
      '焙煎: 幅広い', '精製: 全般', '産地: 汎用', '風味: 甘み×クリア両立',
      '抽出: 浸漬→透過（切替）', '流速: 可変',
      '可変性高', '幅広い調整', '深煎り救済'
    ]
  },
  'ネル': {
    ...
    tags: [
      '焙煎: 中深〜深◎', '精製: ナチュラル/ウェットハル', '産地: スマトラ/ブラジル', '風味: 厚み/余韻',
      '抽出: 濾過穏やか（布）', '流速: 遅',
      'オイル感', '管理必要', 'クラシック'
    ]
  },
  'フレンチプレス': {
    ...
    tags: [
      '焙煎: 中深〜深◎', '精製: ナチュラル/ウェットハル', '産地: ブラジル/スマトラ', '風味: オイル/重厚',
      '抽出: 浸漬式（金属フィルタ）', '流速: 遅',
      '複雑味ダイレクト', '微粉残存', 'クリーンさは下がる'
    ]
  },
  'エアロプレス': {
    short: '可変性高く実験的',
    ...
    tags: [
      '焙煎: 中心は中前後（全域可）', '精製: 全般', '産地: 汎用', '風味: 自由度MAX',
      '抽出: 加圧', '流速: 可変（短〜中）',
      '外でも◎', '設計依存度高'
    ]
  },
  '水出し': {
    ...
    tags: [
      '焙煎: 浅〜中浅/中', '精製: ナチュラル/ウォッシュト', '産地: フルーティ系', '風味: まろやか/低酸',
      '抽出: 低温長時間浸漬', '流速: 極遅',
      '大容量向き', '香り立ちは控えめ'
    ]
  },
  'サイフォン': {
    ...
    tags: [
      '焙煎: 浅〜中◎', '精製: ウォッシュト', '産地: 高香り系', '風味: クリーン×アロマ',
      '抽出: 減圧ろ過（サイフォン）', '流速: 中',
      'クラシック', '器具手間あり'
    ]
  },
  'モカポット': {
    ...
    tags: [
      '焙煎: 中深〜深◎', '精製: ブレンド/ナチュラル', '産地: 南米中心', '風味: 濃厚/ビター',
      '抽出: 加圧蒸気', '流速: 短時間（速）',
      'ミルク◎', '過抽出注意'
    ]
  },
  'エスプレッソ': {
    ...
    tags: [
      '焙煎: 中深〜深◎', '精製: ブレンド/単一ともに可', '産地: 南米/アジア軸', '風味: 凝縮/厚み/余韻',
      '抽出: 高圧短時間', '流速: 極短',
      'ミルク展開', '設計難度高'
    ]
  },
  'クリスタル': {
    ...
    tags: [
      '焙煎: 浅〜中浅◎', '精製: ウォッシュト中心', '産地: 東アフリカ/中米', '風味: 超クリーン/シャープ',
      '抽出: 透過式', '流速: 中〜やや速',
      '検証向き', 'ペーパー性能の影響大'
    ]
  },
  'ブルーボトル': {
    ...
    tags: [
      '焙煎: 浅〜中浅◎', '精製: ウォッシュト', '産地: 中米/東アフリカ', '風味: 軽快/クリーン',
      '抽出: 透過式（単穴）', '流速: やや速',
      '素直に整う', '再現性=中'
    ]
  },
  'フィン': {
    ...
    tags: [
      '焙煎: 中深〜深◎', '精製: ロブスタ/ナチュラル', '産地: ベトナム中心', '風味: 濃厚/甘苦',
      '抽出: 金属フィルタ滴下', '流速: 遅',
      '再現性=中', '紙なし/エコ'
    ]
  },
...
const DRIPPER_KNOWHOW: Record<string, DripperKnowhow> = {
  'ハリオ': {
    ...
    examples: [
      { origin:'エチオピア', process:'ウォッシュト', roast:'浅〜中浅', flavor:'ジャスミン/シトラスをクリアに' },
      { origin:'ケニア',     process:'ウォッシュト', roast:'浅〜中',   flavor:'ベリー/黒スグリ系を輪郭良く' },
      { origin:'コスタリカ', process:'ハニー',       roast:'中浅',     flavor:'明るい甘みと酸のバランス' },
    ],
  },
  'フラワー': {
    pros: ['ガス抜け良好でアロマ立ち','浅〜中浅で華やか'],
    cons: ['深煎りはキレ過多になりがち'],
    howto: { grindGroup:'中細', tempC:86, time:'2:30', pour:'中心やや外→薄く広く', ratioHint:'1:15.5' },
    examples: [
  ...
  'カリタウェーブ': {
    ...
    howto: { grindGroup:'中', tempC:84, time:'2:40', pour:'3投・湯面フラット維持', ratioHint:'1:15〜1:16' },
    examples: [
  ...
  'コーノ': {
    ...
    cons: ['浅煎り×清澄狙いには鈍重'],
    howto: { grindGroup:'中', tempC:84, time:'2:30', pour:'序盤浸漬寄り→後半細口', ratioHint:'1:15' },
    examples: [
  ...
  'クレバー': {
    ...
    examples: [
      { origin:'ブラジル',     process:'ナチュラル', roast:'中〜中深', flavor:'ナッツ/チョコをまろやかに' },
      { origin:'インドネシア', process:'ウェットハル', roast:'中深',   flavor:'スパイス/アーシーを丸く' },
      { origin:'エチオピア',   process:'ナチュラル', roast:'中',       flavor:'発酵香の角を整える' },
    ],
  },
  'ハリオスイッチ': {
    ...
    examples: [
      { origin:'ブラジル',   process:'ナチュラル', roast:'中〜中深', flavor:'甘苦を穏やかに凝縮' },
      { origin:'コロンビア', process:'ウォッシュト', roast:'中',       flavor:'甘みとクリアの両立' },
      { origin:'コスタリカ', process:'ハニー',     roast:'中浅',     flavor:'粘性の甘み×輪郭' },
    ],
  },
  'フレンチプレス': {
  ...
  'エアロプレス': {
    ...
    examples: [
      { origin:'コロンビア', process:'ウォッシュト', roast:'中',   flavor:'クリーン/甘みを短時間で' },
      { origin:'ケニア',     process:'ウォッシュト', roast:'浅',   flavor:'ベリー酸を締めて整える' },
      { origin:'エチオピア', process:'ナチュラル',   roast:'中',   flavor:'発酵香をコントロール' },
    ],
  },
  '水出し': {
    ...
    examples: [
      { origin:'エチオピア', process:'ナチュラル', roast:'浅〜中浅', flavor:'酸を抑え果実の甘みを前へ' },
      { origin:'ブラジル',   process:'ナチュラル', roast:'中',       flavor:'丸いナッツ/チョコ' },
      { origin:'コロンビア', process:'ウォッシュト', roast:'中',       flavor:'柔らかい甘み主体' },
    ],
  },
  'サイフォン': {
    ...
    examples: [
      { origin:'ケニア',     process:'ウォッシュト', roast:'浅〜中', flavor:'アロマと鋭い酸の両立' },
      { origin:'グアテマラ', process:'ウォッシュト', roast:'中',     flavor:'クリーンな甘みと香り' },
      { origin:'コロンビア', process:'ウォッシュト', roast:'中',     flavor:'香りの伸びと透明感' },
    ],
  },
  'フィン': {
    ...
    examples: [
      { origin:'ベトナム', process:'ロブスタ主体', roast:'中深〜深', flavor:'濃厚/甘苦（練乳合わせ）' },
      { origin:'ベトナム', process:'アラビカ',     roast:'中深',     flavor:'ビターカラメル' },
      { origin:'ブレンド', process:'ロブスタ混合', roast:'深',       flavor:'コク重視' },
    ],
  },
  'エスプレッソ': {
    pros: ['凝縮・厚み・余韻'],
    ...
    examples: [
      { origin:'ブラジル中心ブレンド', process:'ナチュラル主体', roast:'中深〜深', flavor:'チョコ/ナッツの土台' },
      { origin:'コロンビア',           process:'ウォッシュト',   roast:'中深',     flavor:'甘み/酸の支え' },
      { origin:'インド',               process:'ロブスタ混合',   roast:'深',       flavor:'クレマ/苦味の補強' },
    ],
  },
  'モカポット': {
    pros: ['濃厚・エスプレッソ風'],
    ...
    examples: [
      { origin:'ブラジル',   process:'ナチュラル', roast:'中深〜深', flavor:'ビター/カカオ' },
      { origin:'メキシコ',   process:'ウォッシュト', roast:'中深',     flavor:'ナッツ/キャラメル' },
      { origin:'ブレンド',   process:'各種',       roast:'深',       flavor:'ミルク合わせ前提' },
    ],
  },
};
...
export function pickRecommendedDrippers(args:{
  ...
  // --- 精製 ---
  if (isFerment){
    ['クレバー','ハリオスイッチ','フレンチプレス','ネル'].forEach(n=> add(n,'精製: 発酵系は甘み/ボディ寄せが◯', +1.8));
    ['ハリオ','フラワー'].forEach(n=> add(n,'精製: 発酵系は輪郭が出過ぎやすい', -1.0));
  }
  if (isNatural){
    ['クレバー','ハリオスイッチ','カリタウェーブ','ハリオ','フラワー'].forEach(n=> add(n,'精製: ナチュラルの香味を活かしやすい', +1.0));
    ['クリスタル'].forEach(n=> add(n,'精製: ナチュラルは微粉が気になりやすい', -0.6));
  }
  if (isHoney){
    ['ハリオ','カリタウェーブ','フラワー','クレバー'].forEach(n=> add(n,'精製: ハニーの甘み/香りを伸ばせる', +0.8));
  }
  if (isWashed){
    ['ハリオ','フラワー','カリタウェーブ','コーノ'].forEach(n=> add(n,'精製: ウォッシュトは清澄系が◯', +0.8));
    ['フレンチプレス','ネル'].forEach(n=> add(n,'精製: ウォッシュトは厚み寄せだと個性が鈍る', -0.6));
  }

  // --- 焙煎 ---
  if (light){
    ['ハリオ','フラワー','カリタウェーブ','コーノ','クリスタル'].forEach(n=> add(n,'焙煎: 浅〜中浅はクリア/香り重視が◯', +1.2));
    ['ネル','フレンチプレス'].forEach(n=> add(n,'焙煎: 浅煎り×厚み寄せは渋みが出やすい', -1.0));
  }
  if (dark){
    ['ネル','フレンチプレス','クレバー','ハリオスイッチ'].forEach(n=> add(n,'焙煎: 深煎りは甘苦/厚み寄せが◯', +1.6));
    ['ハリオ','フラワー','クリスタル'].forEach(n=> add(n,'焙煎: 深煎り×清澄はキレすぎ/えぐみ出やすい', -1.2));
  }
...
<div className="grid grid-cols-2 gap-2">
  ...
  <div>
    <div className="text-xs text-gray-600 mb-1">
      推奨所要時間：
      {showOrDash(!!form.bean_id, formatSecFriendly(Number(derive?.time?.recommended_sec)))}
    </div>
    <input
      className="border rounded p-2 w-full"
